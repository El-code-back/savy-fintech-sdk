  ...
  return (
    <div className="pb-32 pt-10 px-6">
      ...
      <div className="space-y-4">
        <ProfileItem icon={Settings} title="General Settings" />
        <ProfileItem icon={Bell} title="Notifications" />
        <ProfileItem icon={Shield} title="Privacy & Security" />
        <ProfileItem icon={User} title="Account Details" />
        ...
        <div className="pt-6">
          <button className="w-full flex items-center gap-4 bg-red-500/10 border border-red-500/20 rounded-xl p-4 transition-all active:scale-[0.98]">
            ...
            <span className="flex-1 text-left text-sm font-bold text-red-500">Log Out</span>
          </button>
        </div>
      </div>
    </div>
